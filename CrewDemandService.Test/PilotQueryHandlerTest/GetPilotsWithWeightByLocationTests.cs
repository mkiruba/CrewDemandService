...
{
    public class GetPilotsWithWeightByLocationTests : BaseFixture
    {
        [Fact]
        public void Should_Return_Pilots_InDescending()
        {
            ...
            mockPilotRepository.Setup(x => x.GetPilotsByLocation(It.IsAny<string>()))
                .Returns(pilots);
            ...
            //Act
            var actualPilots = pilotQueryHandler.GetPilotsWithWeightByLocation(It.IsAny<string>());
